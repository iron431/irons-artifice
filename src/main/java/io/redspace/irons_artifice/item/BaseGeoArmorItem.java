...
/**
 * {@link BaseGeoItem}'s counterpart for worn pieces. There is no {@code Properties.humanoidArmor} at
 * this version: armour behaviour comes from extending {@link ArmorItem}, so the two hats cannot share
 * a superclass with the guns.
 */
